...
##uncomment line below when using IPCamera and servos
...
def main(_argv):
    ...
    while True:
        ...
        if FLAGS.tracking and detected and frame_num % 15 != 0:
            ...
            if success:
                ...
                detected = False
                cv2.putText(frame, "se perdio la imagen", (30, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
                image = frame
        else:
            detected = False
            ...
            if FLAGS.tracking:
                # tracker, detected = track_object(frame, pred_bbox, allowed_classes, detected)
                trackers, detected = track_many_objects(frame, pred_bbox, allowed_classes, detected)
